  ...
  return (
    <div className="bg-primary w-full overflow-hidden">
      ...
      <div className="w-full bg-gray-50 relative h-[1200px] sm:h-[600px]">
        ...
        <div className="w-[90%] sm:h-[500px] flex justify-center items-center mx-auto mt-15 bg-white rounded-[10px] shadow-lg absolute top-0 left-[5%]">
          <Princing />
        </div>
      </div>

      <div className="w-full bg-gray-50 flex justify-center items-center">
        <div className="w-[80%] flex justify-center items-center mx-auto bg-gray-50 rounded-[10px] py-5">
          <Experiences />
        </div>
      </div>

      <div className="w-full bg-blueFoncee py-5">
        <div className="w-[90%] flex justify-center items-center mx-auto mt-15">
          <Step />
        </div>
      </div>

      <div className="w-full bg-gray-50 flex justify-center items-center py-6">
        <div className="w-[80%] flex justify-center items-center mx-auto  bg-white rounded-[10px]">
          <Mission/>
        </div>
      </div>
