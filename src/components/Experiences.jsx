  ...
  return (
    <section className="bg-gray-50 w-full justify-center h-[100%] pb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-10 w-full">
        <div ref={elementRef} className={` reveal reveal-left ${isVisible ? "show" : ""} delay-50 bg-primary rounded-[10px] p-9`}>
        ...
        <div ref={elementRef} className={`reveal reveal-right ${isVisible ? "show" : ""} delay-70 bg-primary rounded-[10px] p-9`}>
        ...
        <div ref={elementRef} className={` reveal reveal-bottom ${isVisible ? "show" : ""} delay-90 bg-primary rounded-[10px] p-5 w-full col-span-2 flex justify-around items-center flex-col sm:flex-row`}>
          <div>
