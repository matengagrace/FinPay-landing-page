  ...
  return (
    <section className="w-full flex justify-between items-center md:flex-row flex-col sm:py-2 mt-9 py-6">
      <div className="flex flex-col items-start pr-5 font-bold">
        <h2 className={`animation-fade-up text-[35px] delay-150 sm:text-[60px] font-bold  text-blackClaire leading-[1.5] sm:leading-[1.1]`}>
        ...
        <div  className={`animation-fade-up delay-1000 flex w-full mt-5 sm:w-[90%] justify-between items-center flex-col sm:flex-row  relatve sm:border border-gray-400 rounded-[10px]`}>
